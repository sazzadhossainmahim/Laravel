...
{{-- <body class="bg-gray-800 font-sans leading-normal tracking-normal mt-12">
    <div class="container p-3 m-4 min-w-full max-w-full font-sans antialiased font-medium tracking-widest bg-gray-400 flex">
        Welcome to the Point Of Sale dashboard
    </div>
</body> --}}
<body class="bg-gray-800 font-sans leading-normal tracking-normal mt-12">
